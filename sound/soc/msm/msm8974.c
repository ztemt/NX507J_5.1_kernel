...
//Add by lihongda for ext_lineout amp gpio
...
#ifdef CONFIG_ZTEMT_AUDIO_EXT_AMP
//Add by lihongda for ext lineout gpio on or off
...
#ifdef CONFIG_ZTEMT_AUDIO_EXT_AMP
    //Add by lihongda for ext amp gpio on
...
#ifdef CONFIG_ZTEMT_AUDIO_EXT_AMP
    //Add by lihongda for ext amp gpio off
