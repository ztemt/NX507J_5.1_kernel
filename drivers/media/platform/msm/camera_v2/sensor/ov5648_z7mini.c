...
#if defined(CONFIG_ZTE_CAMERA_NX507J) || defined(CONFIG_ZTE_CAMERA_NX505J) || defined(CONFIG_ZTE_CAMERA_NX505H) || defined(CONFIG_ZTE_CAMERA_NX507H)
	{
		.seq_type = SENSOR_VREG,
		.seq_val = 0,
		.config_val = 0,
...
#if defined(CONFIG_ZTE_CAMERA_NX505J) || defined(CONFIG_ZTE_CAMERA_NX505H) || defined(CONFIG_ZTE_CAMERA_Z7MINI)|| defined(CONFIG_ZTE_CAMERA_NX506J)
	{
		.seq_type = SENSOR_GPIO,
		.seq_val = SENSOR_GPIO_VDIG,
		.config_val = GPIO_OUT_LOW,
