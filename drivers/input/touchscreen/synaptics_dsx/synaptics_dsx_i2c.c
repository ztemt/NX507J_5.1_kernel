...
static unsigned char TM_f1a_button_codes[] = {KEY_MENU, KEY_HOMEPAGE, KEY_BACK};
#elif defined CONFIG_ZTEMT_TOUCHSCREEN_SYNAPTICS_S3208_5keys
static unsigned char TM_f1a_button_codes[] = {KEY_MENU, KEY_MENU, KEY_HOMEPAGE, KEY_BACK, KEY_BACK};
